...
<?php 
    ...
    if(isset($_POST['book'])){
        ...
        if(empty($bplace)|| empty($bdate)|| empty($phno)|| empty($des)|| empty($rdate)){
            ...
            if($bdate<$rdate){
            $price=($dur*$carprice);
            $sql="insert into booking (CAR_ID,EMAIL,BOOK_PLACE,BOOK_DATE,PHONE_NUMBER,DESTINATION,PRICE,RETURN_DATE) values($carid,'$uemail','$bplace','$bdate',$phno,'$des',$price,'$rdate')";
       ...
       <div class="hai">
            <div class="navbar">
                ...
                <div class="menu" >
                    ...
                    <li><p class="phello">HELLO! &nbsp;<a id="pname"><?php echo $rows['Username']?></a></p></li>
