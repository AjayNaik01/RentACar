		...
		<div class="row">
			<div class="col-md-4 offset-md-4 form">
				<form name="frm" id="form" action="register.php" method="POST">
					...
					<p class="text-center">Join our family.</p>
					...
					<div class="tacbox">
						...
						<label for="checkbox"> I agree to  <a href="termsandcon.php">Terms and Conditions</a>.</label>
					</div>
					<div class="form-group">
		...
		form.addEventListener('submit', (e) => {
			...
			if (password.value === '' || password.value == null) {
				...
				if (cpassword.value === '' || cpassword.value == null) {
					...
					if (password.value === cpassword.value) {} else {
